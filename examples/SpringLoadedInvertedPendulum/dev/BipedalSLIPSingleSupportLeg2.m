classdef BipedalSLIPSingleSupportLeg2 < DrakeSystem
    ...
    methods
        function obj = BipedalSLIPSingleSupportLeg2(slip)
            ...
            obj = setStateFrame(obj,CoordinateFrame('BipedalSLIPSingleSupport',6,'x',{'x','y','xfoot2','yfoot2','xdot','ydot'}));
